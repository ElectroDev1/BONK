...
function scr_slope_calculatepos() {
	...
	&&(other.y<=slopepos+44){
	   ...
	   other.y=ceil(slopepos-spriteh+4 -44 +6);
	   }else{
	   other.y=ceil(slopepos-spriteh -44 +6);
	   }
   
   
   
	   }
	   else if(object_index==obj_slope_gr){
   
	     other.y=ceil(slopepos-spriteh+4 +6-32);
   
	   }
	   else{
   
	     other.y=ceil(slopepos-spriteh+4 +6) ;
